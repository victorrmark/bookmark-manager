...
export default function EditBookmarkForm({ dialogOpen, setDialogOpen, bookmark }: EditBookmarkFormProps) {
  const bookmarkTags = bookmark.bookmark_tags.map((tag) => ({ tag: tag.tags.tag, id: tag.tags.id }));
  ...
  const { mutateAsync, isPending } = useEditBookmark();
  ...
  const onSubmit = async (data: BookmarkFormData) => {
    const editData = { ...data, bookmark_id: bookmark.id };
    try {
            ...
            <div>
              ...
              >
                ...
                <input
                  type="text"
                  id="title"
                  className={`login-input ${errors.title
            ...
            <div>
              ...
              >
                ...
                <textarea
                  id="description"
                  rows={3}
                  className={`login-input ${errors.description
                      ? "outline-red-800 dark:outline-red-600"
                      : "outline-neutral-500 dark:outline-neutral-300"
                    }`}
            ...
            <div>
              ...
              >
                ...
                <input
                  type="url"
                  id="url"
                  className={`login-input ${errors.url
                      ? "outline-red-800 dark:outline-red-600"
                      : "outline-neutral-500 dark:outline-neutral-300"
                    }`}
                  {...register("url", {
                  ...
                  return (
                    <>
                      ...
                      <div
                        ...
                        className={`min-h-[44px] flex flex-wrap items-center gap-1 px-3 py-2 outline rounded-md cursor-text mt-2 hover:bg-neutral-100 dark:hover:bg-(--neutral-500) dark:bg-(--neutral-600)  ${errors.tags
                            ? "outline-red-800 dark:outline-red-600"
                            : "outline-neutral-500 dark:outline-neutral-300"
                          } ${open
                          ...
                          {filteredTags.map((tags) => {
                            ...
                            return (
                              <button
                                ...
                                className={`w-full text-left px-3 py-2 text-sm hover:bg-neutral-100 dark:hover:bg-(--neutral-500) ${selected
